...
```{r}
EDH_1CAD<- EDH_dated %>% 
  select(id, longitude, latitude, type_of_inscription_clean, height_cm, width_cm, depth_cm, material_clean, type_of_monument_clean, province_label_clean, country_clean, findspot_ancient_clean, clean_text_conservative, clean_text_interpretive_word, clean_text_interpretive_word_lowercase, form_dis_manibus, dis_manibus_in_context_10w, random_dates, date_var_1) %>% 
